...
public class SwitchToPinyinUtils {
    ...
    private static SwitchToPinyinUtils characterParser = new SwitchToPinyinUtils();

    public static SwitchToPinyinUtils getInstance() {
